document.addEventListener("DOMContentLoaded", function () {
  ...
  function validateInputsAndSaveChanges() {
    ...
    var usernameValidationMessage2 = document.getElementById(
      "username-validation-message_new"
    );
    var emailValidationMessage2 = document.getElementById(
      "email-validation-message_new"
    );
  ...
  function validateInputsAndConnectNewsletter() {
    ...
    var emailValidationMessage3 = document.getElementById(
      "email-validation-message_letter"
    );
    var radioButtonsValidation = document.getElementById(
      "radioButtons-validation-message"
    );
    var emailPattern = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
